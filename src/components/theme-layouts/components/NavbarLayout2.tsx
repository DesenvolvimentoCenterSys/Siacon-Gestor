...
function NavbarLayout2(props: NavbarLayout2Props) {
	...
	return (
		<Root className={clsx('h-64 max-h-64 min-h-64 w-full shadow-md bg-orange-500', className)}>
			<div style={{ position: 'absolute', top: 0, right: 0, background: 'black', color: 'white' }}>SHARED NAVBAR</div>
